    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 main-content">
                <h2 class="mt-4">Courses in <?php echo htmlspecialchars($_SESSION['college_name']); ?></h2>

               <!-- Search Bar -->
            <form method="GET" action="courses.php" class="d-flex mt-4">
               <input type="text" name="search_query" class="form-control w-50" placeholder="Search Courses" value="<?php echo htmlspecialchars($search_query); ?>">
